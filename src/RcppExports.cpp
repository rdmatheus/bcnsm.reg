...
RcppExport SEXP _bcnsm_reg_hyp_PDF(SEXP xSEXP, SEXP muSEXP, SEXP sigmaSEXP, SEXP nuSEXP, SEXP log_pSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _bcnsm_reg_hyp_CDF(SEXP qtlSEXP, SEXP muSEXP, SEXP sigmaSEXP, SEXP nuSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _bcnsm_reg_hyp_QTF(SEXP pSEXP, SEXP nuSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _bcnsm_reg_slash_PDF(SEXP xSEXP, SEXP muSEXP, SEXP sigmaSEXP, SEXP nuSEXP, SEXP log_pSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::vec& >::type x(xSEXP);
...
RcppExport SEXP _bcnsm_reg_slash_CDF(SEXP qtlSEXP, SEXP muSEXP, SEXP sigmaSEXP, SEXP nuSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::vec& >::type qtl(qtlSEXP);
...
RcppExport SEXP _bcnsm_reg_slash_QTF(SEXP pSEXP, SEXP nuSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::vec& >::type p(pSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_bcnsm_reg_hyp_PDF", (DL_FUNC) &_bcnsm_reg_hyp_PDF, 5},
    {"_bcnsm_reg_hyp_CDF", (DL_FUNC) &_bcnsm_reg_hyp_CDF, 4},
    {"_bcnsm_reg_hyp_QTF", (DL_FUNC) &_bcnsm_reg_hyp_QTF, 2},
    {"_bcnsm_reg_slash_PDF", (DL_FUNC) &_bcnsm_reg_slash_PDF, 5},
    {"_bcnsm_reg_slash_CDF", (DL_FUNC) &_bcnsm_reg_slash_CDF, 4},
    {"_bcnsm_reg_slash_QTF", (DL_FUNC) &_bcnsm_reg_slash_QTF, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_bcnsm_reg(DllInfo *dll) {
